package org.infiniteloopers.elastic;
...
public class BulkProcessorExample {
    ...
    public static void bulkIndexByActions(Client client) {
        ...
        try {
            ...
            threadPool.updateSettings(Settings.settingsBuilder().put("threadpool.bulk.queue_size", "1000").build());
            threadPool.updateSettings(Settings.settingsBuilder().put("threadpool.bulk.size", "30").build());


            threadPool.updateSettings(Settings.settingsBuilder().put("threadpool.index.queue_size", "1000").build());
            threadPool.updateSettings(Settings.settingsBuilder().put("threadpool.index.size", "30").build());
